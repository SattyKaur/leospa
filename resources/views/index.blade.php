...
<div class="banner">
    ...
    <div class="navBar">
        ...
        <div class="links ml-8 font-serif xs:hidden xl:flex">
    ...
    <div class="links font-serif mt-6 xs:flex xl:hidden">
    ...
    <div style="margin-top: 150px">
        <h3 class="spacing text-coral font-sans">SPA & BEAUTY CENTER</h3>
        ...
        <div class="playButton md:float-left md:mt-0 xs:mt-5 xs:inline-block"><span class="material-icons play">arrow_right</span>
...
<div class="testimonial text-center">
    ...
    <p class="font-sans leading-loose xs:px-8">First I beast be fruitful open you tree all Won't can't likeness and you're have
...
<div class="popularProcedures">
    ...
    <div class="cardContainer">
        <div class="card border-2 border-lightGrey mx-4">
            <div class="bg-grey cardImg"></div>
            <p class="smallText font-serif text-center p-1 text-grey text-xs leading-loose">
